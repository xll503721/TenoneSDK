...
#pragma mark - WindGPBSourceContextRoot
 ...
 **/
WindGPB_FINAL @interface WindGPBSourceContextRoot : WindGPBRootObject
@end

#pragma mark - WindGPBSourceContext

typedef WindGPB_ENUM(WindGPBSourceContext_FieldNumber) {
  WindGPBSourceContext_FieldNumber_FileName = 1,
};
 ...
 **/
WindGPB_FINAL @interface WindGPBSourceContext : WindGPBMessage
