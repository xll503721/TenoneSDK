 ...
 **/
WindGPB_FINAL @interface WindGPBAnyRoot : WindGPBRootObject
@end

#pragma mark - WindGPBAny

typedef WindGPB_ENUM(WindGPBAny_FieldNumber) {
  WindGPBAny_FieldNumber_TypeURL = 1,
  WindGPBAny_FieldNumber_Value = 2,
};
 ...
 *     }
 **/
WindGPB_FINAL @interface WindGPBAny : WindGPBMessage
