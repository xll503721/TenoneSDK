...
extern unsigned long long const kSMDefaultLogMaxFileSize;
extern NSTimeInterval     const kSMDefaultLogRollingFrequency;
extern NSUInteger         const kSMDefaultLogMaxNumLogFiles;
extern unsigned long long const kSMDefaultLogFilesDiskQuota;
 ...
 *  or an array of `SMLogFileInfo` objects.
 *  The `SMLogFileInfo` class is documented below, and provides a handy wrapper that
 *  gives you easy access to various file attributes such as the creation date or the file size.
 */
@protocol SMLogFileManager <NSObject>
@required
...
/**
 * Returns an array of `SMLogFileInfo` objects,
 * each representing an existing log file on disk,
 * and containing important information about the log file such as it's modification date and size.
 **/
@property (nonatomic, readonly, strong) NSArray<SMLogFileInfo *> *unsortedLogFileInfos;
 ...
 * The first item in the array will be the most recently created log file.
 **/
@property (nonatomic, readonly, strong) NSArray<SMLogFileInfo *> *sortedLogFileInfos;

// Private methods (only to be used by SMFileLogger)
...
// Notifications from SMFileLogger
 ...
 **/
@interface SMLogFileManagerDefault : NSObject <SMLogFileManager>
...
/* Inherited from SMLogFileManager protocol:
 ...
 **/
@interface SMLogFileFormatterDefault : NSObject <SMLogFormatter>
 ...
 */
@interface SMFileLogger : SMAbstractLogger <SMLogger> {
	SMLogFileInfo *_currentLogFileInfo;
}
...
/**
 *  Designated initializer, requires a `SMLogFileManager` instance
 */
- (instancetype)initWithLogFileManager:(id <SMLogFileManager>)logFileManager NS_DESIGNATED_INITIALIZER;
 ...
 */
- (BOOL)shouldArchiveRecentLogFileInfo:(SMLogFileInfo *)recentLogFileInfo;
...
/**
 * The SMLogFileManager instance can be used to retrieve the list of log files,
 * and configure the maximum number of archived log files to keep.
 *
 * @see SMLogFileManager
 **/
@property (strong, nonatomic, readonly) id <SMLogFileManager> logFileManager;
...
// Inherited from SMAbstractLogger

// - (id <SMLogFormatter>)logFormatter;
// - (void)setLogFormatter:(id <SMLogFormatter>)formatter;
 ...
 **/
@property (nonatomic, readonly, strong) SMLogFileInfo *currentLogFileInfo;
...
/**
 * `SMLogFileInfo` is a simple class that provides access to various file attributes.
 ...
 **/
@interface SMLogFileInfo : NSObject
...
- (NSComparisonResult)reverseCompareByCreationDate:(SMLogFileInfo *)another;
- (NSComparisonResult)reverseCompareByModificationDate:(SMLogFileInfo *)another;
