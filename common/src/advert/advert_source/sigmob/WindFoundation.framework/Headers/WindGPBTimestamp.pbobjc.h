...
#pragma mark - WindGPBTimestampRoot
 ...
 **/
WindGPB_FINAL @interface WindGPBTimestampRoot : WindGPBRootObject
@end

#pragma mark - WindGPBTimestamp

typedef WindGPB_ENUM(WindGPBTimestamp_FieldNumber) {
  WindGPBTimestamp_FieldNumber_Seconds = 1,
  WindGPBTimestamp_FieldNumber_Nanos = 2,
};
 ...
 **/
WindGPB_FINAL @interface WindGPBTimestamp : WindGPBMessage
