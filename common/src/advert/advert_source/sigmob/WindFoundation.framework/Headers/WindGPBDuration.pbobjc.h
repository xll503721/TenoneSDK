...
#pragma mark - WindGPBDurationRoot
 ...
 **/
WindGPB_FINAL @interface WindGPBDurationRoot : WindGPBRootObject
@end

#pragma mark - WindGPBDuration

typedef WindGPB_ENUM(WindGPBDuration_FieldNumber) {
  WindGPBDuration_FieldNumber_Seconds = 1,
  WindGPBDuration_FieldNumber_Nanos = 2,
};
 ...
 **/
WindGPB_FINAL @interface WindGPBDuration : WindGPBMessage
