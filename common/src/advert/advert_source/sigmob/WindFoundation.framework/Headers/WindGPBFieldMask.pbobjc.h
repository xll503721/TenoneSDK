...
#pragma mark - WindGPBFieldMaskRoot
 ...
 **/
WindGPB_FINAL @interface WindGPBFieldMaskRoot : WindGPBRootObject
@end

#pragma mark - WindGPBFieldMask

typedef WindGPB_ENUM(WindGPBFieldMask_FieldNumber) {
  WindGPBFieldMask_FieldNumber_PathsArray = 1,
};
 ...
 **/
WindGPB_FINAL @interface WindGPBFieldMask : WindGPBMessage
