...
/** Category of additions for @c SMDatabase  class.
...
@interface SMDatabase (SMDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `SMResultSet` of schema; @c nil  on error.
 
 @see [SQLite File Format](https://sqlite.org/fileformat.html)
 */

- (SMResultSet * _Nullable)getSchema;
...
- (SMResultSet * _Nullable)getTableSchema:(NSString*)tableName;
