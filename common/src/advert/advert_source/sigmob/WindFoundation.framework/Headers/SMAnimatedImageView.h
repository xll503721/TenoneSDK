...
@class SMAnimatedImage;
@protocol SMAnimatedImageViewDebugDelegate;


//
//  An `SMAnimatedImageView` can take an `SMAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface SMAnimatedImageView : UIImageView
...
@property (nonatomic, strong) SMAnimatedImage *animatedImage;
